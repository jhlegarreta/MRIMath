...
def createSegNetWithIndexPooling(input_shape, 
                                 n_labels, 
                                 k,
                                 kernel=3, 
                                 pool_size=(2, 2), 
    ...
    if depth == 1:
        return create1LayerSegNetWithIndexPooling(input_shape, 
                                                  n_labels, 
                                                  k, 
                                                  kernel, 
                                                  pool_size, 
                                                  output_mode)
    if depth == 2:
        return create2LayerSegNetWithIndexPooling(input_shape, 
                                                  n_labels, 
                                                  k, 
                                                  kernel, 
                                                  pool_size, 
        ...
        return create3LayerSegNetWithIndexPooling(input_shape, n_labels, k, kernel, pool_size, output_mode)
...
def create1LayerSegNetWithIndexPooling(input_shape, 
                                       n_labels, 
                                       k,
                                       kernel=3, 
                                       pool_size=(2, 2),
    ...
    unpool_2 = MaxUnpooling2D(pool_size)([ pool_1, mask_1])

    conv_9 = Convolution2D(k, (kernel, kernel), padding="same")(unpool_2)
    conv_9 = BatchNormalization()(conv_9)
    conv_9 = PReLU()(conv_9)
    conv_10 = Convolution2D(k, (kernel, kernel), padding="same")(conv_9)
    conv_10 = BatchNormalization()(conv_10)
    conv_10 = PReLU()(conv_10)
    
  
    conv_13 = Convolution2D(n_labels, (1, 1), padding='valid')(conv_10)
    conv_13 = BatchNormalization()(conv_13)
