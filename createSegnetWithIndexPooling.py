...
def create3LayerSegNetWithIndexPooling(input_shape, n_labels, kernel=3, pool_size=(2, 2), output_mode="sigmoid"):
    ...
    conv_8 = Convolution2D(256, (kernel, kernel), padding="same")(unpool_1)
    ...
    conv_11 = Convolution2D(128, (kernel, kernel), padding="same")(unpool_2)
    ...
    conv_13 = Convolution2D(64, (kernel, kernel), padding="same")(unpool_3)
    conv_13 = BatchNormalization()(conv_13)
    conv_13 = PReLU()(conv_13)
    conv_14 = Convolution2D(64, (kernel, kernel), padding="same")(conv_13)
