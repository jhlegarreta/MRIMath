...
def TF_Canny(img_tensor,
    ...
    """
    Gx = tf.nn.convolution(img_tensor, h_filter, padding='VALID')
    Gy = tf.nn.convolution(img_tensor, v_filter, padding='VALID')
