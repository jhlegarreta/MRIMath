...
with tf.device('/cpu:0'):
    ...
    module_1 = concatenate([tower_1, tower_2, tower_3], axis = 3)
    tower_4 = Conv2D(64, (1,1), padding='same', activation='relu')(module_1)
    tower_4 = Conv2D(64, (3,3), padding='same', activation='relu')(tower_4)
    tower_5 = Conv2D(64, (1,1), padding='same', activation='relu')(module_1)
    tower_5 = Conv2D(64, (5,5), padding='same', activation='relu')(tower_5)
    tower_6 = MaxPooling2D((3,3), strides=(1,1), padding='same')(module_1)
    tower_6 = Conv2D(64, (1,1), padding='same', activation='relu')(tower_6)
    module_2 = concatenate([tower_4, tower_5, tower_6], axis = 3)
    
    tower_7 = Conv2D(64, (1,1), padding='same', activation='relu')(module_2)
    tower_7 = Conv2D(64, (3,3), padding='same', activation='relu')(tower_7)
    tower_8 = Conv2D(64, (1,1), padding='same', activation='relu')(module_2)
    tower_8 = Conv2D(64, (5,5), padding='same', activation='relu')(tower_8)
    tower_9 = MaxPooling2D((3,3), strides=(1,1), padding='same')(module_2)
    tower_9 = Conv2D(64, (1,1), padding='same', activation='relu')(tower_9)
    module_3 = concatenate([tower_7, tower_8, tower_9], axis = 3)
    flat = Flatten()(module_3)
    fc1 = Dense(256)(flat)
