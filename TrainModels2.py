...
for i in range(10,10,200):
    for j in range(10,10,200):
        for k in range(10,10,200):
            ...
            with tf.device('/cpu:0'):
                ...
                #flat = Flatten()(module_2)
                #fc1 = Dense(150, activation='relu')(flat)
                #fc2 = Dense(75, activation='relu')(fc1)
                #out    = Dense(1, activation='softmax')(fc2)
                #model = Model(inputs = input_img, outputs = out)
                
                input_img = shape=(dataHandler.n, dataHandler.n, 1)
                model = Sequential()
                model.add(Conv2D(i, (3, 3), input_shape=input_img, padding='same'))
            ...
            emailHandler.sendMessage(["Danny", "Dr.Bouaynaya", "Dr.Rasool"])
            emailHandler.finish()
