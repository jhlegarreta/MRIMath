...
def fuckingBullshit(dataHandler, num_cores, training_directory, X_train, segment_data, start, finish):
        ...
        Parallel(n_jobs=num_cores)(delayed(dataHandler.loadIndividualImage(training_directory, i, X_train, segment_data) for i in range(start, finish)))
...
class DataHandler:
    ...
    def loadDataParallel(self, training_directory, start, finish):
        ...
        fuckingBullshit(self, num_cores, training_directory, X_train, segment_data, start, finish)
